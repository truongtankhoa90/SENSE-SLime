...
class LimeImageExplainer(object):
        ...
        for label in top:
            (ret_exp.intercept[label],
             ...
             test_result) = self.base.testing_explain_instance_with_data(
                ...
                feature_selection=self.feature_selection,
                alpha=alpha)
        return ret_exp, test_result, len(used_features)
    ...
    def slime(self,
        ...
        while True:
            ret_exp, test_result, num_feat = self.testing_explain_instance(image=image,
                                                                 ...
                                                                 progress_bar=progress_bar)
            flag = False
            for k in range(1, num_feat):  # changes num_features + 1 to num_features because it fixes bug
